...
<form class="form-horizontal" enctype="multipart/form-data"
	method="post"
	action="@if(isset($expensescategory)){{ URL::to('admin/expensescategory/'.$expensescategory->id.'/edit') }}
	        @else{{ URL::to('admin/expensescategory/create') }}@endif"
	autocomplete="off">
	<!-- CSRF Token -->
				...
				<div class="form-group {{{ $errors->has('title') ? 'has-error' : '' }}}">
					<div class="col-md-12">
						<label class="control-label" for="title"> {{
							...
							value="{{{ Input::old('title', isset($expensescategory) ? $expensescategory->title : null) }}}" />
