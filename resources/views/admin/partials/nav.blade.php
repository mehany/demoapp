...
Dashboard</span>
    ...
    <li {{ (Request::is('admin/customers*') ? ' class=active' : '') }}>
        <a href="#">
            <i class="glyphicon glyphicon-bullhorn"></i> Companies<span
                    class="fa arrow"></span>
        </a>
            ...
            <li {{ (Request::is('admin/customers') ? ' class=active' : '') }} >
                <a href="{{URL::to('admin/customers')}}">
                    <i class="glyphicon glyphicon-list"></i><span
                            class="hidden-sm text"> Companies /Customers </span>
                </a>
            </li>
        </ul>
    </li>
    <li {{ (Request::is('admin/missions*') ? ' class=active' : '') }}>
        <a href="#">
            <i class="glyphicon glyphicon-bullhorn"></i> Missions<span
                    class="fa arrow"></span>
        </a>
        <ul class="nav nav-second-level collapse">
            <li {{ (Request::is('admin/customers') ? ' class=active' : '') }} >
                <a href="{{URL::to('admin/missions')}}">
                    <i class="glyphicon glyphicon-list"></i><span
                            class="hidden-sm text"> Missions  </span>
                </a>
            </li>
        </ul>
    </li>  
    <li {{ (Request::is('admin/tenders*') ? ' class=active' : '') }}>
        <a href="#">
            <i class="glyphicon glyphicon-bullhorn"></i> Tenders<span
                    class="fa arrow"></span>
        </a>
        <ul class="nav nav-second-level collapse">
            <li {{ (Request::is('admin/tenders') ? ' class=active' : '') }} >
                <a href="{{URL::to('admin/tenders')}}">
                    <i class="glyphicon glyphicon-list"></i><span
                            class="hidden-sm text"> Tenders  </span>
                </a>
            </li>
        </ul>
    </li>  
 <!-- <li {{ (Request::is('admin/news*') ? ' class=active' : '') }}>
    ...
    <li {{ (Request::is('admin/expenses*') ? ' class=active' : '') }}>
        <a href="#">
            <i class="glyphicon glyphicon-bullhorn"></i> Expenses items<span
                    class="fa arrow"></span>
        </a>
        <ul class="nav nav-second-level collapse">
            <li {{ (Request::is('admin/expensescategory') ? ' class=active' : '') }} >
                <a href="{{URL::to('admin/expensescategory')}}">
                    <i class="glyphicon glyphicon-list"></i><span
                            class="hidden-sm text"> Expenses categories </span>
                </a>
            </li>
            <li {{ (Request::is('admin/expensessubcategory') ? ' class=active' : '') }} >
                <a href="{{URL::to('admin/expensessubcategory')}}">
                    <i class="glyphicon glyphicon-list"></i><span
                            class="hidden-sm text"> Expenses Sub Categories </span>
                </a>
            </li>
            <li {{ (Request::is('admin/expenses') ? ' class=active' : '') }} >
                <a href="{{URL::to('admin/expenses')}}">
                    <i class="glyphicon glyphicon-bullhorn"></i><span
                            class="hidden-sm text"> Expenses</span>
                </a>
            </li>
        </ul>
    </li> 
